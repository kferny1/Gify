var showTitle = ['Game of Thrones', 'Sherlock bbc', 'Mr. Robot', 'Daredevil', 'Unbreakable Kimmy Schmidt', 'The Flash', 'Supergirl','iZombie', 'The Magicians', 'Arrow', 'Emerald City',];
...
function createButtons(){
	...
	$('.showBtn').on('click', function(){
		...
		var giphyURL = "http://api.giphy.com/v1/gifs/search?q=tv+show+" + thisShow + "&limit=10&api_key=Z9Iax1O0GnFY28NNvAiVS7TMLAZN0Ajv";
